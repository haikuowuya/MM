package com.maimengapp.hsh.view;
...
import com.maimengapp.hsh.helper.ViewDragHelper;
...
public class SwipeBackFrameLayout extends FrameLayout
{
    ...
    public SwipeBackFrameLayout(Context context, AttributeSet attrs)
    {
        ...
        shadowGradientDrawable.setGradientType(GradientDrawable.LINEAR_GRADIENT);
        setShadow(shadowGradientDrawable, EDGE_LEFT);
        setShadow(shadowGradientDrawable, EDGE_RIGHT);
        setShadow(shadowGradientDrawable, EDGE_BOTTOM);
...
//         TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SwipeBackFrameLayout, defStyle, R.style.SwipeBackFrameLayout);

//        int edgeSize = a.getDimensionPixelSize(R.styleable.SwipeBackFrameLayout_edge_size, -1);
//        if (edgeSize > 0) setEdgeSize(edgeSize);
        setEdgeSize((int) (getResources().getDisplayMetrics().density * DEFAULT_EDGE_SIZE));
//        int mode = EDGE_FLAGS[a.getInt(R.styleable.SwipeBackFrameLayout_edge_flag, 0)];
        int mode = EDGE_FLAGS[0];
        setEdgeTrackingEnabled(mode);

//        int shadowLeft = a.getResourceId(R.styleable.SwipeBackFrameLayout_shadow_left, R.drawable.shadow_left);
//        int shadowRight = a.getResourceId(R.styleable.SwipeBackFrameLayout_shadow_right, R.drawable.shadow_right);
//        int shadowBottom = a.getResourceId(R.styleable.SwipeBackFrameLayout_shadow_bottom, R.drawable.shadow_bottom);
        GradientDrawable shadowGradientDrawable = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, new int[]{0X00000000, DEFAULT_SCRIM_COLOR});
        shadowGradientDrawable.setGradientType(GradientDrawable.LINEAR_GRADIENT);
        setShadow(shadowGradientDrawable, EDGE_LEFT);
        setShadow(shadowGradientDrawable, EDGE_RIGHT);
...
//        a.recycle();
    ...
    public void setShadow(Drawable shadow, int edgeFlag)
    {
        ...
        {
            mShadowLeft = shadow;
//            GradientDrawable gradientLeft =    new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT,new int[]{0X00000000,DEFAULT_SCRIM_COLOR});
//            gradientLeft.setGradientType(GradientDrawable.LINEAR_GRADIENT);
//
//            mShadowLeft =  gradientLeft;
...
//    }
    ...
    private void drawShadow(Canvas canvas, View child)
    {
        ...
        if ((mEdgeFlag & EDGE_LEFT) != 0)
        {
            ...
            // mShadowLeft.setBounds(childRect.left - mShadowLeft.getIntrinsicWidth(), childRect.top, childRect.left, childRect.bottom);//DEFAULT

            mShadowLeft.setBounds(0, childRect.top, childRect.left, childRect.bottom);//SELF
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback
    {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy)
        {
            ...
            //System.out.println("mContentLeft = " + mContentLeft + " mContentTop = " + mContentTop + " height = " + mContentView.getHeight());
            invalidate();
